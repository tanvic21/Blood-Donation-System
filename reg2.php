...
<div class="page-wrap">
  ...
  if (isset($_POST['sub'])) {
    ...
    if ($q->execute()) {
      echo '<div class="alert" style="background:#d1fae5;color:#065f46;border:1px solid #a7f3d0;">✅ Patient registered successfully!</div>';
    } else {
  ...
  <div class="form-card">
    <form method="post">
      ...
      <div class="form-row">
        <label>Age</label>
        <input type="text" name="age" placeholder="e.g. 30">
      </div>
      <div class="form-row">
      ...
      <div class="btn-row">
        <button type="submit" name="sub" class="btn btn-primary">Register Patient</button>
